...
<html lang="en" dir="ltr">
  ...
  <body style="background-image: url('hello.jpg');background-size: cover;">
    <div class="container" style="border-radius:10px;background-color:rgba(180,180,180,0.6)">
        <h1 style="text-align: center"><b>SUBJECTS</b></h1>
    ...
    <div class="row" >
        ...
        <div class="col-lg-3" style="border-radius:10px;background-color:rgba(180,180,180,0.6);margin-left: 30px;">
          <a href="add_subject.php"> <center><img src="add.png" height="150" width="150" ></center> </a>
          <h4 style="text-align:center; ">ADD SUBJECT</h4>
        </div>
        <div class="col-lg-3" style="border-radius:10px;background-color:rgba(180,180,180,0.6);margin-left: 30px;">
          <a href="delete_subject.php"> <center><img src="trash.png" height="150" width="150"> </center></a>
          <h4 style="text-align:center; ">DELETE SUBJECT</h4>
        </div>
        <div class="col-lg-3" style="border-radius:10px;background-color:rgba(180,180,180,0.6);margin-left: 30px;">
          <a href="view_subject.php"> <center><img src="student_group.png" height="150" width="150"> </center></a>
